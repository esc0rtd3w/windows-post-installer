...
set installer=none
set appName=Visual C++ 2005 Redistributable
::set silentSwitch=/q:a /c:"VCREDI~3.EXE /q:a /c:""msiexec /i vcredist.msi /qn!"" " 
set silentSwitch=/q
...
::set silentSwitch=/q:a /c:"VCREDI~2.EXE /q:a /c:""msiexec /i vcredist.msi /qn"" "
set silentSwitch=/q
